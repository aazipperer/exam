package com.xugah.exam.config;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.servlet.InstrumentedFilter;
import com.codahale.metrics.servlets.MetricsServlet;
import com.xugah.exam.web.filter.CachingHttpHeadersFilter;
import com.xugah.exam.web.filter.StaticResourcesProductionFilter;
import com.xugah.exam.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "com.xugah.exam.web.websocket");
