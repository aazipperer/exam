...
examApp.controller('AdminController', function ($scope) {
    });

examApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
examApp.controller('MenuController', function ($scope) {
    });

examApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
examApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

examApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
examApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
examApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
examApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
examApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
 ...
 examApp.controller('TrackerController', ['AccessToken'], function ($scope, AccessToken) {
...
examApp.controller('HealthController', function ($scope, HealthCheckService) {
...
examApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
        $scope.metrics = {};
...
examApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
examApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
